...
/**
 * Speichert die Konfiguartionsdaten des EA's im Chart, sodaß der Status nach einem Recompilation oder Terminal-Restart daraus wiederhergestellt werden kann.
