...
#import "stdlib.ex4"
 ...
 //datetime GetLocalSessionStartTime(datetime localTime);
   ...
   // Math, Numbers
   bool     CompareDoubles(double a, double b);                            // MetaQuotes-Alias f�r EQ()
   ...
   string   DoubleToStrMorePrecision(double number, int precision);        // MetaQuotes-Alias f�r DoubleToStrEx()
   ...
   string   IntegerToHexStr(int integer);                                  // MetaQuotes-Alias f�r IntToHexStr()
