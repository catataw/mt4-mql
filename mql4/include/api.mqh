...
int    ec_SetInitCycle         (int ec[], int    status   );;
...
bool   ec_SetTesting           (int ec[], int    status   );;
bool   ec_SetVisualMode        (int ec[], int    status   );;
bool   ec_SetOptimization      (int ec[], int    status   );;
int    ec_SetMqlError          (int ec[], int    error    );;
int    ec_SetDllError          (int ec[], int    error    );;
int    ec_SetDllWarning        (int ec[], int    error    );;
bool   ec_SetLogging           (int ec[], int    logging  );;
string ec_SetCustomLogFile     (int ec[], string logFile  );;
