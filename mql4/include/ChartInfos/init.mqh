...
int onInitParameterChange() {
   if (isLfxInstrument) {
      // offene Pending-Orders der aktuellen W‰hrung einlesen
      LFX.GetSelectedOrders(lfxOrders, lfxCurrency, OF_PENDINGORDER|OF_PENDINGPOSITION);

      // in Library gespeicherte Remote-Positionsdaten restaurieren, kˆnnen aktueller als die gelesenen Remote-Orderdaten sein
...
int onInitChartChange() {
   ...
   if (isLfxInstrument) {
      ...
      // in Library gespeicherte Remote-Positionsdaten restaurieren, kˆnnen aktueller als die Remote-Orderdaten sein
...
int onInitUndefined() {
   if (isLfxInstrument) {
      // offene Pending-Orders der aktuellen LFX-W‰hrung einlesen
      LFX.GetSelectedOrders(lfxOrders, lfxCurrency, OF_PENDINGORDER|OF_PENDINGPOSITION);
