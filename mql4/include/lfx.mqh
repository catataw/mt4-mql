...
bool LFX.SaveOrder(/*LFX_ORDER*/int los[], int index=NULL) {
   ...
   string sTakeProfitLfx  =                ifString(!lo.TakeProfitLfx (lo), "0", DoubleToStr(lo.TakeProfitLfx(lo), lo.Digits(lo)));                                       sTakeProfitLfx  = StringLeftPad (sTakeProfitLfx ,  7, " ");  // "TkProft"
