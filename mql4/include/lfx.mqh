...
/**
 * MQL4 structure LFX_ORDER: gespeicherte Preise sind LFX-Preise, für tatsächliche Preise gilt: realPrice + lfxDeviation = lfxPrice
 *
 * struct LFX_ORDER {
