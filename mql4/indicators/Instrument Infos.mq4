...
int UpdateInfos() {
   ...
   double freezeLevel  = MarketInfo(symbol, MODE_FREEZELEVEL)/PipPoints;
      string strSpread      = DoubleToStr(spread,      Digits<<31>>31); ObjectSetText(names[SPREAD        ], StringConcatenate("Spread:        "      , strSpread     , " pip"), Font.Size, Font.Name, Font.Color);
      string strStopLevel   = DoubleToStr(stopLevel,   Digits<<31>>31); ObjectSetText(names[STOPLEVEL     ], StringConcatenate("Stop level:   "  , strStopLevel  , " pip"), Font.Size, Font.Name, Font.Color);
      string strFreezeLevel = DoubleToStr(freezeLevel, Digits<<31>>31); ObjectSetText(names[FREEZELEVEL   ], StringConcatenate("Freeze level: ", strFreezeLevel, " pip"), Font.Size, Font.Name, Font.Color);
