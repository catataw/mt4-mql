...
string StringArrayToStr(string& array[]) {
   if (ArraySize(array) == 0)
      return("{}");
   return(StringConcatenate("{\"", JoinStrings(array, "\", \""), "\"}"));
}
 ...
 *
 * Beispiel: RGBColor(255, 255, 255) => 0x00FFFFFF (weiß)
 */
...
/**
 * Konvertiert eine Farbe aus dem RGB- in den HSV-Farbraum (Hue-Saturation-Value = Farbton-Sättigung-Helligkeit).
 *
 * @param  int red
 * @param  int green
 * @param  int blue
