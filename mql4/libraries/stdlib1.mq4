...
string GetLongSymbolNameStrict(string symbol) {
   ...
   else if (suffix == ".AE") { if (StringIsDigit(prefix)) return(StringConcatenate("Account Equity"  , " #", prefix          )); }
   else if (suffix == ".EX") { if (StringIsDigit(prefix)) return(StringConcatenate("Account Equity"  , " #", prefix, " + AuM")); }
   else if (suffix == ".AL") { if (StringIsDigit(prefix)) return(StringConcatenate("Account Leverage", " #", prefix          )); }
